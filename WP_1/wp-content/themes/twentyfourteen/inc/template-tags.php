...
function twentyfourteen_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<div class="nav-links">
			<?php
			if ( is_attachment() ) :
				previous_post_link( '%link', __( '<span class="meta-nav">Published In<span>%title</span></span>', 'twentyfourteen' ) );
			else :
				previous_post_link( '%link', __( '<span class="meta-nav">前の投稿</span><div>%title</div>', 'twentyfourteen' ) );
				next_post_link( '%link', __( '<span class="meta-nav">次の投稿</span><div>%title</div>', 'twentyfourteen' ) );
			endif;
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
